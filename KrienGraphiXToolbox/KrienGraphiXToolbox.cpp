...
namespace kgt
{
    ...
    void KrienGraphiXToolbox::openSceneFile()
    {
        ...
        //const std::string sceneFile = R"(E:\Dropbox\projects\KrienGraphiX_projects\KrienGraphiX\ProjectDir\scenes\kalimariDesert.kgscene)";
        const std::string sceneFile = R"(C:\Users\kalko\Dropbox\projects\KrienGraphiX_projects\KrienGraphiX\ProjectDir\scenes\kalimariDesert.kgscene)";

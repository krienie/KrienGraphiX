...
namespace kgx
{
							  ...
							  const TextureLibrary &sceneTextures )
	{
		...
		float m_clearColor[4] = {0.4f, 0.4f, 0.4f, 1.0f};
		dxDeferredDevCont->ClearRenderTargetView( diffuseBuffView, m_clearColor );
		dxDeferredDevCont->OMSetRenderTargets( 1, &diffuseBuffView, m_depthStencilView );
